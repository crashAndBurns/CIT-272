 ...
 * Date: 5/4/2025
 * Purpose: create a GUI version of a
 * calculator for class. The calculator will be step Four towards
 ...
 * the expression while operators will be added to the accumulator
 * surrounded by two spaces. When the clear button is clicked, the expression
 * will reset to the empty string and when the = is clicked the program will check for a
 * valid expression. If the expression is valid then the computed value of the expression
 * will appear in the results window. Otherwise "INVALID" will appear.
 */
