 ...
 * Date: 5/4/2025
 * Purpose: Build the a CLI Calculator using Java. We will
 * work with input and output, basic data types, string operations,
 * conditionals, and loops. This basic CLI calculator will handle
 * simple mathematical operations including -, +, *, /, and ^. Note
 * that handling parentheses is beyond the scope of the project as
 * noted by the instructor in the project directions. For the purposes
 * of this exercise I also performed basic input validation. To use
 * the CLI Calculator enter a mathematical expression with each
 * token separated by a space. The program will detect any invalid input.
 */
...
public class CLICalculator {
    public static void main(String[] args) {
        ...
        // Create a new calculator object before the input loop
        ...
        if (expression.equals("quit")) {
            ...
            while(!expression.equals("quit")) {
                ...
                if (calculatorObject.isValidExpression(tokens)){
                    double results = calculatorObject.evaluate(tokens);
